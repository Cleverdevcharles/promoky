...
const ProductsManager = (props) => {
    ...
    const {title, price, discount, inStock, description, content, category} = product
					...
					<div className="col-12">
						<div className="bread-inner">
							<ul className="bread-list">
								...
								<li className="active"><Link href="/create">Product Manager</Link></li>
							</ul>
						</div>
					</div>
				</div>
        ...
        <div className="products_manager container">
            <form className="row" onSubmit={handleSubmit}>
                ...
                <div className="col-md-6 my-4">
                    ...
                    <label htmlFor="discount" className='mt-1'>Percentage Discount (Optional) %</label>
                    <input type="number" name="discount" value={discount}
                    placeholder="Discount" className="d-block w-100 p-2 mb-4"
                    min={0}
                    onChange={handleChangeInput} />
